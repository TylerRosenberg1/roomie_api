...
var UserSchema = new Schema({
  ...
  roommates: [{roommie: {type: Schema.Types.ObjectId, ref: "User"}, status: {type: String, default: "pending"}, requests: [{type: Schema.Types.ObjectId, ref: "Request"}], balance: {type: Number, default: 0}}]
})
