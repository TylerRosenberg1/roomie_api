...
var UserSchema = new Schema({
  ...
  roommates: [{roommate: {type: Schema.Types.ObjectId, ref: "User"}, status: {type: String, default: "pending"}, requests: [{description: String, amount: Number}], balance: {type: Number, default: 0}}]
})
